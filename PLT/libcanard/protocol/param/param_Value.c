 ...
 *
 * Source file: E:\DSDL\libcanard\dsdl_compiler\pyuavcan\uavcan\dsdl_files\uavcan\protocol\param\Value.uavcan
 */
#include "Value.h"
#include "../../canard.h"
  ...
  uint8_t CANARD_MAYBE_UNUSED(root_item))
{
    ...
    // Union Tag 3 bits
    canardEnSclr(msg_buf, offset, 3, (void*)&source->union_tag); // 3 bits
    //offset += 3;
    ...
    canardEnSclr(msg_buf, offset, 64, (void*)&source->integer_value); // 9223372036854775807
    //offset += 64;

    }
    else if (source->union_tag == 2) {
    canardEnSclr(msg_buf, offset, 32, (void*)&source->real_value); // 2147483647
    //offset += 32;

    }
    else if (source->union_tag == 3) {
    canardEnSclr(msg_buf, offset, 8, (void*)&source->boolean_value); // 255
    //offset += 8;
    ...
    {
        // - Add array length
        canardEnSclr(msg_buf, offset, 8, (void*)&source->string_value.len);
        //offset += 8;
    }
