 ...
 *
 * Source file: E:\DSDL\libcanard\dsdl_compiler\pyuavcan\uavcan\dsdl_files\uavcan\protocol\SoftwareVersion.uavcan
 */
...
{
    canardEnSclr(msg_buf, offset, 8, (void*)&source->major); // 255
    //offset += 8;

    canardEnSclr(msg_buf, offset, 8, (void*)&source->minor); // 255
    //offset += 8;

    canardEnSclr(msg_buf, offset, 8, (void*)&source->optional_field_flags); // 255
    //offset += 8;

    canardEnSclr(msg_buf, offset, 32, (void*)&source->vcs_commit); // 4294967295
    //offset += 32;

    canardEnSclr(msg_buf, offset, 64, (void*)&source->image_crc); // 18446744073709551615
    //offset += 64;
