 ...
 *
 * Source file: E:\DSDL\libcanard\dsdl_compiler\pyuavcan\uavcan\dsdl_files\uavcan\protocol\5.RestartNode.uavcan
 */
  ...
  uint8_t CANARD_MAYBE_UNUSED(root_item))
{
    ...
    canardEnSclr(msg_buf, offset, 40, (void*)&source->magic_number); // 1099511627775
    //offset += 40;
  ...
  uint8_t CANARD_MAYBE_UNUSED(root_item))
{
    ...
    canardEnSclr(msg_buf, offset, 1, (void*)&source->ok); // 1
    //offset += 1;
