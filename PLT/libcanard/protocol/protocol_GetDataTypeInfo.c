  ...
  uint8_t CANARD_MAYBE_UNUSED(root_item))
{
    ...
    canardEnSclr(msg_buf, offset, 16, (void*)&source->id); // 65535
    //offset += 16;
    ...
    {
        // - Add array length
        canardEnSclr(msg_buf, offset, 7, (void*)&source->name.len);
        //offset += 7;
    }
  ...
  uint8_t CANARD_MAYBE_UNUSED(root_item))
{
    ...
    canardEnSclr(msg_buf, offset, 64, (void*)&source->signature); // 18446744073709551615
    //offset += 64;
    ...
    // Compound
    offset = uavcan_protocol_DataTypeKind_encode_internal(&source->kind, msg_buf, offset, 0);
    canardEnSclr(msg_buf, offset, 8, (void*)&source->flags); // 255
    //offset += 8;
