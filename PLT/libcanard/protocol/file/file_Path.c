 ...
 *
 * Source file: E:\DSDL\libcanard\dsdl_compiler\pyuavcan\uavcan\dsdl_files\uavcan\protocol\file\Path.uavcan
 */
#include "Path.h"
#include "../../canard.h"
  ...
  uint8_t CANARD_MAYBE_UNUSED(root_item))
{
    ...
    {
        // - Add array length
        canardEnSclr(msg_buf, offset, 8, (void*)&source->path.len);
        //offset += 8;
    }
