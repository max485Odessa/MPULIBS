 ...
 *
 * Source file: E:\DSDL\libcanard\dsdl_compiler\pyuavcan\uavcan\dsdl_files\uavcan\protocol\file\45.GetInfo.uavcan
 */
#include "GetInfo.h"
#include "../../canard.h"
  ...
  uint8_t CANARD_MAYBE_UNUSED(root_item))
{
    ...
    canardEnSclr(msg_buf, offset, 40, (void*)&source->size); // 1099511627775
    //offset += 40;
