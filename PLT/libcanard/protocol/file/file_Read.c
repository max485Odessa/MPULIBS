 ...
 *
 * Source file: E:\DSDL\libcanard\dsdl_compiler\pyuavcan\uavcan\dsdl_files\uavcan\protocol\file\48.Read.uavcan
 */
#include "Read.h"
#include "../../canard.h"
  ...
  uint8_t CANARD_MAYBE_UNUSED(root_item))
{
    ...
    canardEnSclr(msg_buf, offset, 40, (void*)&source->offset); // 1099511627775
    //offset += 40;
  ...
  uint8_t CANARD_MAYBE_UNUSED(root_item))
{
    ...
    {
        // - Add array length
        canardEnSclr(msg_buf, offset, 9, (void*)&source->data.len);
        //offset += 9;
    }
