...
{
    canardEnSclr(msg_buf, offset, 8, (void*)&source->source_node_id); // 255
    //offset += 8;
  ...
  uint8_t CANARD_MAYBE_UNUSED(root_item))
{
    ...
    canardEnSclr(msg_buf, offset, 8, (void*)&source->error); // 255
    //offset += 8;
    ...
    {
        // - Add array length
        canardEnSclr(msg_buf, offset, 7, (void*)&source->optional_error_message.len);
        //offset += 7;
    }
