  ...
  uint8_t CANARD_MAYBE_UNUSED(root_item))
{
    ...
    {
        // - Add array length
        canardEncodeScalar(msg_buf, offset, 6, (void*)&source->ecef_position_velocity.len);
        offset += 6;
    }
    ...
    {
			offset = uavcan_equipment_gnss_ECEFPositionVelocity_encode_internal((uavcan_equipment_gnss_ECEFPositionVelocity*)&source->ecef_position_velocity.data[c], msg_buf, offset, 0); 	
        //offset = uavcan_equipment_gnss_ECEFPositionVelocity_encode_internal((void*)&source->ecef_position_velocity.data[c], msg_buf, offset, 0); // uavcan_equipment_gnss_ECEFPositionVelocity  11.19
    }
  ...
  int32_t offset)
{
    ...
    for (c = 0; c < dest->ecef_position_velocity.len; c++)
    {
        offset = uavcan_equipment_gnss_ECEFPositionVelocity_decode_internal(transfer,
                                                0,
                                                //(void*)&dest->ecef_position_velocity.data[c], // uavcan_equipment_gnss_ECEFPositionVelocity
																								(uavcan_equipment_gnss_ECEFPositionVelocity*)&dest->ecef_position_velocity.data[c], 
                                                dyn_arr_buf,
                                                offset);
    }
    return offset;
