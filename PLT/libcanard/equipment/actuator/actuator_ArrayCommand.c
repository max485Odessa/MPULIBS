  ...
  uint8_t CANARD_MAYBE_UNUSED(root_item))
{
    ...
    {
        offset = uavcan_equipment_actuator_Command_encode_internal((uavcan_equipment_actuator_Command*)(void*)&source->commands.data[c], msg_buf, offset, 0);
    }
  ...
  int32_t offset)
{
    ...
    for (c = 0; c < dest->commands.len; c++)
    {
        offset = uavcan_equipment_actuator_Command_decode_internal(transfer,
                                                0,
                                                (uavcan_equipment_actuator_Command*)(void*)&dest->commands.data[c],
                                                dyn_arr_buf,
                                                offset);
    }
    return offset;
