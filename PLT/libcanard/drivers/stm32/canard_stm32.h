...
#define CANARD_CAN_FRAME_MAX_DATA_LEN               8U   // 19.02.21
	
#define CANARD_CAN_EXT_ID_MASK                      0x1FFFFFFFU      		// 19.02.21
#define CANARD_CAN_FRAME_EFF                        (1UL << 31U)         ///< Extended frame format  // 19.02.21
#define CANARD_CAN_FRAME_RTR                        (1UL << 30U)         ///< Remote transmission (not used by UAVCAN) // 19.02.21
#define CANARD_CAN_STD_ID_MASK                      0x000007FFU 				// 19.02.21
#define CANARD_CAN_FRAME_ERR                        (1UL << 29U)         ///< Error frame (not used by UAVCAN)   // 19.02.21
