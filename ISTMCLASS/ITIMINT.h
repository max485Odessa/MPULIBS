...
class ITIM_MKS_USER_A {
	...
	public:
		ITIM_MKS_USER_A (ESYSTIM t, uint32_t prd, uint32_t fr);
...
class ITIM_MKS_ISR: public ITIM_MKS_USER_A {
	...
	public:
		ITIM_MKS_ISR (ESYSTIM t, uint32_t prd, uint32_t fr, ITIMCB *cb);
		void isr_tim ();
